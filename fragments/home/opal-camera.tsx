  ...
  return (
    <section>
      <Container className="px-gutter">
        <div className="xl:flex flex-row-reverse justify-center pb-48 pt-32 xl:space-x-10 xl:space-x-reverse">
          <div>
            <img
          ...
          <div className="pt-20 ">
            <h2 className="font-heading font-bold text-[34px] xl:text-[40px] mb-4  max-w-[545px] mx-auto xl:mx-0">
              From front-end to full-stack
            </h2>
            <div className="max-w-[545px] mx-auto xl:mx-0 space-y-5 xl:text-[17px]">
              <p>
