  ...
  <div class="Aside">
    <div class="Aside-content">
      ...
      There are a <a href="https://github.com/zeit/next.js/tree/master/examples">
        ton of examples
      </a> of how to integrate various loaders and other packages in with Next. I
      would highly recommend reading them because this is SSR land, and things need
      to be set up in special ways in order to function properly.
    </div>
  </div>
</div>
