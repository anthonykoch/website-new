  ...
  return (
    <>
      ...
      <div className="max-w-site mx-auto relative z-20 px-4">
        ...
        <p className="pt-[15vh] z-40 w-full text-[clamp(36px,6vw,74px)] text-black font-600 leading-[1.15] lg:leading-none tracking-[-0.25px] font-heading lg:text-center max-w-[1200px] mx-auto">
        ...
        <div className="text-center relative">
          <div className="z-10 relative">
            <img
              ...
              className="min-w-[1200px] absolute top-[-50px] left-1/2 -translate-x-1/2 -z-10"
            />
            <img
