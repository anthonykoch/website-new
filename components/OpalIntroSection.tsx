...
export const OpalIntroSection = () => {
  ...
  const opalIntroSectionScroller = useScroll({
    target: opalIntroSectionRef,
    offset: ['75vh end', '110vh end'],
  })

  const opalIntroSectionScale = useTransform(
    opalIntroSectionScroller.scrollYProgress,
    [0, 1],
    [1, 0.97],
  )
  const opalIntroSectionY = useTransform(
    opalIntroSectionScroller.scrollYProgress,
    [0, 1],
    [0, 300],
  )
              ...
              <h3 className="font-bold text-[14px] uppercase tracking-[1.4px] text-right mb-[10px]">
                <span className="relative">
                  <span className="setup-overflow">
                    <span className="selector-opal-camera-title">
                      Opal Camera
                    </span>
                  </span>
                </span>
